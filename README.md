...
```bash
# 1. 啟動 MongoDB（首次會自動 pull image，等個一兩分鐘）
docker compose up -d mongodb

# 2. 後續模組各自的 README 會說明啟動流程：
#    api/README.md         — cargo run / cargo test
#    admin-web/README.md   — pnpm install / pnpm dev
```

預設連線字串：`mongodb://argus:argus@localhost:27017/argus?authSource=admin`
